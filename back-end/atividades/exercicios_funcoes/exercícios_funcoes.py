...
def carga_tributaria(preco_de_venda,custo,lucro):#calcula o valor da carga tributaria 

    imposto = preco_de_venda - (custo + lucro)
    valor_carga_tributaria = (preco_de_venda / imposto) * 100

    return valor_carga_tributaria

print(carga_tributaria(1500,400,785))
...
def clientes_inadimplentes(lista_clientes_devedores): #lista deve conter tuplas na ordem: (cpf , valor devido em int ou float, dias)

    lista_clientes_inadimplentes = []
    for cliente in lista_clientes_devedores:

        cpf = cliente[0]
        valor_devido = cliente[1]
        dias = cliente[2]

        if(valor_devido > 1000 and dias > 20):
            lista_clientes_inadimplentes.append(cpf)
            
    
    return lista_clientes_inadimplentes
...
# def clientes_inadimplentes(cpf,valor_devido,qtde_de_dias): #função que verifica se o cliente é inadimplente, retorna cpf dos devendo

#     if(valor_devido > 1000 and qtde_de_dias > 20):
#         variavel_clientes_inadimplentes = cpf
#         return variavel_clientes_inadimplentes




# lista_de_clientes_inadimplentes = []

# for clientes in clientes_devedores:
#     cpf = clientes[0]
#     valor_devido = clientes[1]
#     dias = clientes[2]

#     if(clientes_inadimplentes(cpf,valor_devido,dias) != None):
#         lista_de_clientes_inadimplentes.append(clientes_inadimplentes(cpf,valor_devido,dias))


# print(lista_de_clientes_inadimplentes)
